        ...
        <div class="container-xxl project py-5">
           <div class="container">
               <div class="text-center mx-auto mb-3 wow fadeInUp" data-wow-delay="0.1s"> 
                   <p class="mb-4" style="font-size: 16px; display: flex; justify-content: center; align-items: center; flex-wrap: wrap;">
                       Interested in exploring more about investing in the Nova Summer Meadows deal?<a href="./assets/NOVA RTP 2680_.pdf" style="max-width: 250px; margin-left: 0px; font-family: 'Montserrat', sans-serif; display: inline-block; text-align: center;" class="py-2 px-4" download="NovaSummerMeadows.pdf" target="_blank"><i class="fas fa-file-pdf"></i> Download Deck
                       </a>
                   </p> 
               </div> 
           </div>        
           ...
           <div class="container">
               <div class="row g-5">
                   <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                       ...
                       <h2 class="display-5 mb-4">First steps towards investing in the Nova Summer Meadows</h2>
                       <p class="mb-4">Our team is here to answer any questions you may have about our properties, amenities, investment opportunities, or anything else you're curious about.</p>
                       <div class="row g-4">
                           <div class="col-12">
                               <div class="d-flex">
                                   ...
                                   <div class="ms-4">
                                       ...
                                       <h5 style="font-family: 'Montserrat', sans-serif;" class="mb-0">+1 (919) 597-0020</h5>
                                   </div>
                               </div>
                           </div>
                           <div class="col-12">
                               <div class="d-flex">
                                   ...
                                   <div class="ms-4">
                                       ...
                                       <h5 style="font-family: 'Montserrat', sans-serif;" class="mb-0">abraham@abranova.com</h5>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="row g-3">
                         ...
                         <script>
                           hbspt.forms.create({
                             region: "na1",
                             portalId: "45057484",
                             formId: "e8dc65eb-81fa-4462-bf65-a5f6f7a004fc"
                           });
                         </script>
                       </div>
                   </div>
